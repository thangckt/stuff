...
%{python3_sitearch}/albumentations/
%{python3_sitearch}/albumentations-*.dist-info/
%{python3_sitearch}/timm/
%{python3_sitearch}/timm-*.dist-info/
%{python3_sitearch}/transformers/
%{python3_sitearch}/transformers-*.dist-info/
%{python3_sitearch}/x_transformers/
%{python3_sitearch}/x_transformers-*.dist-info/
%{python3_sitearch}/tokenizers/
%{python3_sitearch}/tokenizers-*.dist-info/
%{python3_sitearch}/cv2/
%{python3_sitearch}/opencv_python_headless-*.dist-info/
